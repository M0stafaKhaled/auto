                ...
                <div class="col-md-12">
                    ...
                    <div class="wm-breadcrumb">
                        <ul>
                            ...
                            <li><a href="profile.php">Courses</a></li>
                            <li>Single Course</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="tab_container">
                ...
                <div id="tab2" class="tab_content">
                    ...
                    <div class="row ro-op">
                        ...
                        <div class="col-md-8">Future Academy</div>
                    ...
                    <div class="row ro-op">
                        ...
                        <div class="col-md-4">
                            <select class="form-control js-example-tags" style="width:150px;" name="tab_department_offering_course">
                                <option selected="selected">علوم الحاسب</option>
                                <option>ادارة اعمال عربي</option>
                                <option>نظم المعلومات الادارية </option>
                                <option>ادارة اعمال ومحاسبة انجليزي</option>
                            </select>
                        </div>
                    </div>
                    <a href="https://www.futureacademyegypt.com/ar/home#" class="wm-banner-btn submit" tabindex="0">learn more</a>
                </div>
                <!-- #tab2 -->
...
<br><br><br>
        ...
        <!-- files-->
        <div class="tabs-contain">
            <h1 class="title-tabs">Quality Assurance Files</h1>
            <ul class="tabs">

                <li class="active" rel="tab5">Quiz One Files</li>
                <li rel="tab6">Midterm Files </li>
                <li rel="tab7">Quiz Two Files </li>

            </ul>
            <div class="tab_container">

                <!-- #tab5 -->
                <h3 class="tab_drawer_heading" rel="tab5">Quiz One Files</h3>
                <div id="tab5" class="tab_content">
                    <h2>Quiz One Files</h2>
                    <div class="row ro-op">
                        <div class="col-md-4">Quiz One Exam</div>
                        
                        <div class="field">

<div class="control">
    <input type="file" class="form-control-file" name="reportToUpload" aria-describedby="fileHelp">
</div>
</div>

                    <div class="row ro-op">
                        <div class="col-md-4">Quiz One Model Answer</div>
                        <div class="col-md-4">
                            <select class="form-control js-example-tags" style="width:150px;" name="tab_department_offering_course">
                                <option selected="selected">علوم الحاسب</option>
                                <option>ادارة اعمال عربي</option>
